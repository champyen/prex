### Goal
port crossdb to Prex
* don't delegate to sub-agent
* refer to the git cloned source ../sqlite
  - port the version with tag "version-3.53.0"
  - refer to the structure of ../sqlite3 ported to ms-rtos
  - refer to [Custom Builds Of SQLite](https://sqlite.org/custombuild.html) official port guide
...
2. partition, format: add /usr/sbin to PATH, you can use mkfs.vfat
...
### Output
sqlite3 should be ported under ./usr/sample/sqlite
And it should be tested to store data on disk image.
