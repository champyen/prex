...
const sysent: [NSYSCALL]SysEnt = .{
    ...
    SysEnt.init("task_create", 3, c.task_create),
    SysEnt.init("task_terminate", 1, c.task_terminate),
    SysEnt.init("task_self", 0, c.task_self),
    ...
    SysEnt.init("thread_create", 2, c.thread_create),
    SysEnt.init("thread_terminate", 1, c.thread_terminate),
    SysEnt.init("thread_setup", 4, c.thread_setup),
    SysEnt.init("thread_self", 0, c.thread_self),
    SysEnt.init("thread_yield", 0, c.thread_yield),
    SysEnt.init("thread_suspend", 1, c.thread_suspend),
    SysEnt.init("thread_resume", 1, c.thread_resume),
